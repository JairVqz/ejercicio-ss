...
@XmlRootElement(name = "MostrarTareasResponse")
public class MostrarTareasResponse {

    @XmlElement(required = true)
    protected List<MostrarTareasResponse.Tarea> tarea;
     ...
     * {@link MostrarTareasResponse.Tarea }
     * 
     * 
     */
    public List<MostrarTareasResponse.Tarea> getTarea() {
        if (tarea == null) {
            tarea = new ArrayList<MostrarTareasResponse.Tarea>();
        }
        return this.tarea;
    }
